...
async function findItemsByName(itemName) {
  console.log("[findItemsByName] Searching for:", itemName);
  ...
  const itemNames = Object.values(result.items).map(i => i.name);
  console.log("[findItemsByName] Available items:", itemNames);
